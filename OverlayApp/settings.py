"""
Django settings for OverlayApp project.
...
SECRET_KEY = 'django-insecure-+q9jo_0oc9g8hg%4vhpzz&ndgmza!w!j3b9042q(j7wvs9dg9$'
...
ROOT_URLCONF = 'OverlayApp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'networkapp' / 'Frontend' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'OverlayApp.wsgi.application'
